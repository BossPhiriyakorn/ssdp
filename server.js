...
app.post('/api/admin/members', requireAuth, async (req, res) => {
  ...
  const { data, error } = await supabase.from('members').insert({
    ...
    department: b.department||null, expertise: b.expertise||null,
    house_no: b.house_no||null, village_no: b.village_no||null, village_name: b.village_name||null,
    soi: b.soi||null, road: b.road||null, subdistrict: b.subdistrict||null,
    district: b.district||null, province: b.province||null, postal_code: b.postal_code||null,
